...
# 270 "C:\Program Files (x86)\Microchip\xc8\v2.00\pic\include\pic18f25k83.h"
...
extern volatile __bit CCP1CTS3 __at(0x1FBFB);
...
extern volatile __bit CCP2CTS3 __at(0x1FBDB);
...
extern volatile __bit CCP3CTS3 __at(0x1FBBB);
...
extern volatile __bit CCP4CTS3 __at(0x1FB9B);
...
extern volatile __bit MST2PRAIF __at(0x1CD32);
...
extern volatile __bit U1MODE3 __at(0x1EF93);
...
void set_buffer_8(uint8_t reg, uint8_t data_in);
void set_buffer_16(const uint8_t, const uint16_t);
...
# 8 "C:\Program Files (x86)\Microchip\xc8\v2.00\pic\include\c90\time.h"
typedef long time_t;
struct tm {
int tm_sec;
int tm_min;
...
if (channel % 2 == 0) do { LATAbits.LATA1 = 1; } while(0);
else do { LATAbits.LATA1 = 0; } while(0);

if ((channel == 3)||(channel == 4)) do { LATAbits.LATA2 = 1; } while(0);
else if ((channel == 7)||(channel == 8)) do { LATAbits.LATA2 = 1; } while(0);
else if ((channel == 11)||(channel == 12)) do { LATAbits.LATA2 = 1; } while(0);
else if ((channel == 15)||(channel == 16)) do { LATAbits.LATA2 = 1; } while(0);
else do { LATAbits.LATA2 = 0; } while(0);

if ((channel == 5)||(channel == 6)) do { LATAbits.LATA3 = 1; } while(0);
else if ((channel == 7)||(channel == 8)) do { LATAbits.LATA3 = 1; } while(0);
else if ((channel == 13)||(channel == 14)) do { LATAbits.LATA3 = 1; } while(0);
else if ((channel == 15)||(channel == 16)) do { LATAbits.LATA3 = 1; } while(0);
else do { LATAbits.LATA3 = 0; } while(0);

if (channel > 8) do { LATAbits.LATA4 = 1; } while(0);
else do { LATAbits.LATA3 = 0; } while(0);
...
uint16_t get_adc(const uint8_t channel) {
...
return (uint16_t)(ADCC_GetConversionResult());
}
...
uint16_t result = get_adc(i);
buf2[i] = ((double)(result));
buf[i] = ((double)(result)) * resolution;
set_buffer_16(i, 512+i);

}

TMR0_StopTimer();

set_buffer_16(17, TMR0_ReadTimer());
