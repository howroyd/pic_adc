...
void led_high(void) {do { LATBbits.LATB0 = 1; } while(0);}
void led_low(void) {do { LATBbits.LATB0 = 0; } while(0);}
...
out_val = (int16_t)(ADCC_GetConversionResult()) & 0x3ff;
