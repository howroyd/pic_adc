...
volatile uint8_t I2C1_buffer[64] = {0x00};
...
I2C1_buffer[eepromAddress++] = I2C1_slaveWriteData;

if(sizeof(I2C1_buffer) <= eepromAddress)
{
eepromAddress = 0;
}
break;
...
I2C1TXB = I2C1_buffer[eepromAddress++];
}
...
void set_buffer_8(uint8_t reg, uint8_t data_in) {
if ( reg > 127 ) return;
I2C1_buffer[reg] = data_in;
}

void set_buffer_16(const uint8_t reg, const uint16_t data_in) {
if ( reg > 63 ) return;
I2C1_buffer[reg*2] = (uint8_t)(data_in>>8) & 0xFF;
I2C1_buffer[(reg*2)+1] = (uint8_t)(data_in) & 0xFF;
return;
}
